 ...
 * Copyright (C) 2013-2015 The LineageOS Project
...
static int start_input_stream(struct stream_in *in)
{
    ...
    int flags = PCM_IN|PCM_MONOTONIC;
...
static in_get_capture_position(const struct audio_stream_in *stream,
                               int64_t *frames,
                               int64_t *time)
{
    struct stream_in *in;
